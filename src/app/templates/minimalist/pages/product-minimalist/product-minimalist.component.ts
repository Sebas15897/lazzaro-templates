...
@Component({
  selector: 'app-product-minimalist',
  templateUrl: './product-minimalist.component.html',
  styleUrls: ['./product-minimalist.component.scss']
})

export class ProductMinimalistComponent implements OnInit, OnDestroy {
