...
@Component({
  selector: 'app-service-clasic',
  templateUrl: './service-clasic.component.html',
  styleUrls: ['./service-clasic.component.scss'],
})

export class ServiceClasicComponent implements OnInit, OnDestroy {
  ...
  buy() {
    this.router.navigate([`/classic/pay-service/${this.serviceId}`]);
  }
